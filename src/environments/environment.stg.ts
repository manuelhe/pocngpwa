export const environment = {
  ...
  contentServiceApiUrl: 'https://stg-content.foxsportsla.com',
  authorizationApiUrl: 'https://jmsloiwko9.execute-api.us-east-1.amazonaws.com/stg_auth_crypto',
