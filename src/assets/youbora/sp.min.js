...
/**
 * @license
 * Adnalyzer 5.3.0-onceux <http://youbora.com/>
 * Copyright NicePopleAtWork <http://nicepeopleatwork.com/>
 */
"undefined"!=typeof $YB&&($YB.adnalyzers.OnceUX=function(e,n){try{this.adnalyzerVersion="5.3.0-onceux",this.startMonitoring(e,e.player.onceux)}catch(r){$YB.error(r)}},$YB.adnalyzers.OnceUX.prototype=new $YB.adnalyzers.Generic,$YB.adnalyzers.OnceUX.prototype.getAdResource=function(){return this.ads.timeline.contenturi},$YB.adnalyzers.OnceUX.prototype.getMediaPlayhead=function(){return this.plugin.player.ads.snapshot&&this.plugin.player.ads.snapshot.currentTime?this.plugin.player.ads.snapshot.currentTime:null},$YB.adnalyzers.OnceUX.prototype.getAdPlayhead=function(){return this.ads.currentTime()},$YB.adnalyzers.OnceUX.prototype.getAdDuration=function(){return this.ads.duration()},$YB.adnalyzers.OnceUX.prototype.registerVideojs=function(){try{this.registerListeners()}catch(e){$YB.error(e)}},$YB.adnalyzers.OnceUX.prototype.registerListeners=function(){try{$YB.utils.listenAllEvents(this.plugin.player,[null,"onceux-ads-complete","onceux-adroll-start","onceux-adroll-complete","onceux-linearad-start","onceux-linearad-impression","onceux-linearad-complete","onceux-linearad-skipped","onceux-linearad-pause","onceux-linearad-resume","onceux-companionad-creativeView"],function(e){$YB.debug("Event: OUX > "+e.type)}),this.enableAdBufferMonitor();var e=this;this.plugin.player.on("onceux-linearad-start",function(n){try{e.plugin.sendIgnoringAd&&(e.plugin.sendIgnoringAd=!1,e.plugin.viewManager.isShowingAd=!1,$YB.noticeRequest("Converting ignoringAds to propper AdStart")),e.startJoinAdHandler()}catch(r){$YB.error(r)}}),this.plugin.player.on("onceux-linearad-pause",function(n){try{e.pauseAdHandler()}catch(r){$YB.error(r)}}),this.plugin.player.on("onceux-linearad-resume",function(n){try{e.resumeAdHandler()}catch(r){$YB.error(r)}}),this.plugin.player.on("onceux-linearad-complete",function(n){try{e.endedAdHandler()}catch(r){$YB.error(r)}}),this.plugin.player.on("onceux-linearad-skipped",function(n){try{e.skipAdHandler()}catch(r){$YB.error(r)}})}catch(n){$YB.error(n)}});
