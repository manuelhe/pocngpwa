export const environment = {
  ...
  contentServiceApiUrl: 'http://dev-backend-content-glb.foxites.com',
  authorizationApiUrl: 'http://dev-backend-auth-glb.foxites.com/',
  ...
  hostedSolutions: {
    matchInformationUrl: 'https://dev-stats.foxsportsla.com/stats/get_results_by_matchcode_foxsports'
  },
  seo:{
    title: "Fox",
